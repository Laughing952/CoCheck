...
import com.unistrong.business.animation.AlphaInAnimation;
import com.unistrong.business.animation.BaseAnimation;
import com.unistrong.business.animation.ScaleInAnimation;
import com.unistrong.business.animation.SlideInBottomAnimation;
import com.unistrong.business.animation.SlideInLeftAnimation;
import com.unistrong.business.animation.SlideInRightAnimation;
import com.unistrong.business.entity.IExpandable;
import com.unistrong.business.ui.hodler.BaseViewHolder;
import com.unistrong.business.utile.MultiTypeDelegate;
import com.unistrong.business.views.LoadMoreView;
import com.unistrong.business.views.SimpleLoadMoreView;
...
public abstract class BaseItemAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    protected static final String TAG = BaseItemAdapter.class.getSimpleName();
     ...
     */
    public BaseItemAdapter(@LayoutRes int layoutResId, @Nullable List<T> data) {
    ...
    public BaseItemAdapter(@Nullable List<T> data) {
        this(0, data);
    }

    public BaseItemAdapter(@LayoutRes int layoutResId) {
...
//        autoLoadMore(position);
    ...
    public void setOnItemClick(View v, int position) {
        getOnItemClickListener().onItemClick(BaseItemAdapter.this, v, position);
    }
    ...
    public boolean setOnItemLongClick(View v, int position) {
        return getOnItemLongClickListener().onItemLongClick(BaseItemAdapter.this, v, position);
    }
    ...
    /**
     * When the current adapter is empty, the BaseItemAdapter can display a special view
...
//            subItemCount += list.size();
    ...
    public interface OnItemChildClickListener {
         ...
         */
        void onItemChildClick(BaseItemAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemChildLongClickListener {
         ...
         */
        boolean onItemChildLongClick(BaseItemAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         * @return true if the callback consumed the long click ,false otherwise
         */
        boolean onItemLongClick(BaseItemAdapter adapter, View view, int position);
    }
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(BaseItemAdapter adapter, View view, int position);
    }
