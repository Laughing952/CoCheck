...
import com.unistrong.business.ui.adapter.BaseItemAdapter;
...
public class BaseViewHolder extends RecyclerView.ViewHolder {
    ...
    public BaseViewHolder setImageUrl(@IdRes int viewId, String url) {
        ImageView view = getView(viewId);
        LoadImageUtile.loadCircleImage(view,url);
        return this;
    }
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setAdapter(BaseItemAdapter adapter) {
