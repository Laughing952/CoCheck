...
import com.statistics.ui.acitivty.A_FloatingPersonnel_Statistics;
...
public class FloatingPersonnelStatisticsPresenter {

    private AssistantStatisticsView statisticsView;
    private BaseActivity activity;
    private LifecycleProvider lifecycleProvider;

    public FloatingPersonnelStatisticsPresenter(AssistantStatisticsView statisticsView, BaseActivity activity
    ...
    public void initData() {
        ...
        httpManager.doHttpDeal(RetrofitHelper.getApiService().getFloatingPersonnelStatisticsList(srartDate, endDate)
