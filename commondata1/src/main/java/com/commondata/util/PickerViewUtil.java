...
public class PickerViewUtil {
    ...
    public static void showSelectDatePickerViewBefore(Context context, String titleStr, DateSelectListener selectListener) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static void showSelectDatePickerViewBefore(Context context, String titleStr, String selDateStr, DateSelectListener selectListener) {
        Calendar calendar = Calendar.getInstance();
    ...
    public static void showSelectDatePickerViewBefore(Context context, String titleStr, String startDateStr, String selDateStr, DateSelectListener selectListener) {
    ...
    public static void showSelectDatePickerView(Context context, DateSelectListener selectListener, String titleStr
        ...
        new TimePickerView.Builder(context, (date, v) -> {//选中事件回调
            ...
            selectListener.result(DateUtil.getStringByFormat(date, "yyyyMMdd"));
