package com.commondata.takephoto.activity;
...
import com.commondata.takephoto.adapter.MyPhotoAdapter;
import com.commondata.takephoto.uilts.Image;
    ...
    private void gotoCamera() {
        ...
        if (SDState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                ...
                Uri contentUri = FileProvider.getUriForFile(MyPhotoActivity.this, "com.unistrong.cocheck.fileProvider", tempFile);
