...
public class S_DownLoadApp extends Service {
    ...
    public void onCreate() {
        ...
        myNotify.icon = R.mipmap.ic_login_logo;
...
//        myNotify.when = System.currentTimeMillis();
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        File outputFile = new File(Environment.getExternalStoragePublicDirectory
                (Environment.DIRECTORY_DOWNLOADS), "CoCheck.apk");
        //下载路径
        ...
        downloadUtils.download(strUrl, new DownloadListener() {
            ...
            public void onSuccess(ResponseBody responseBody) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    intent.setDataAndType(FileProvider.getUriForFile(getApplicationContext(), "com.unistrong.cocheck.fileProvider", outputFile),
